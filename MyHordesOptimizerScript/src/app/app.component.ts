...
export class AppComponent {
  ...
  constructor() {
    console.log('test script généré');
  }
  ...
  // let mh_user = localStorage.getItem(mh_user_key);
  // let external_app_id = localStorage.getItem(gm_mh_external_app_id_key);
  ...
  //     if (mho_parameters.display_camping_predict && pageIsDesert()) {
