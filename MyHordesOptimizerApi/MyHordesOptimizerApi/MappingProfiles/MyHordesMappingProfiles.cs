    ...
    public class MyHordesMappingProfiles : Profile
    {
        public MyHordesMappingProfiles()
        {
            ...
            CreateMap<EstimationsDto, TownEstimationModel>()
                ...
                .ForMember(dest => dest._0Min, opt => { opt.MapFrom(src => src._0 != null ? src._0.Min : -1); })
                .ForMember(dest => dest._0Max, opt => { opt.MapFrom(src => src._0 != null ? src._0.Max : -1); })
                .ForMember(dest => dest._4Min, opt => { opt.MapFrom(src => src._4 != null ? src._4.Min : -1); })
                .ForMember(dest => dest._4Max, opt => { opt.MapFrom(src => src._4 != null ? src._4.Max : -1); })
                .ForMember(dest => dest._8Min, opt => { opt.MapFrom(src => src._8 != null ? src._8.Min : -1); })
                .ForMember(dest => dest._8Max, opt => { opt.MapFrom(src => src._8 != null ? src._8.Max : -1); })
                .ForMember(dest => dest._13Min, opt => { opt.MapFrom(src => src._13 != null ? src._13.Min : -1); })
                .ForMember(dest => dest._13Max, opt => { opt.MapFrom(src => src._13 != null ? src._13.Max : -1); })
                .ForMember(dest => dest._17Min, opt => { opt.MapFrom(src => src._17 != null ? src._17.Min : -1); })
                .ForMember(dest => dest._17Max, opt => { opt.MapFrom(src => src._17 != null ? src._17.Max : -1); })
                .ForMember(dest => dest._21Min, opt => { opt.MapFrom(src => src._21 != null ? src._21.Min : -1); })
                .ForMember(dest => dest._21Max, opt => { opt.MapFrom(src => src._21 != null ? src._21.Max : -1); })
                .ForMember(dest => dest._25Min, opt => { opt.MapFrom(src => src._25 != null ? src._25.Min : -1); })
                .ForMember(dest => dest._25Max, opt => { opt.MapFrom(src => src._25 != null ? src._25.Max : -1); })
                .ForMember(dest => dest._29Min, opt => { opt.MapFrom(src => src._29 != null ? src._29.Min : -1); })
                .ForMember(dest => dest._29Max, opt => { opt.MapFrom(src => src._29 != null ? src._29.Max : -1); })
                .ForMember(dest => dest._33Min, opt => { opt.MapFrom(src => src._33 != null ? src._33.Min : -1); })
                .ForMember(dest => dest._33Max, opt => { opt.MapFrom(src => src._33 != null ? src._33.Max : -1); })
                .ForMember(dest => dest._38Min, opt => { opt.MapFrom(src => src._38 != null ? src._38.Min : -1); })
                .ForMember(dest => dest._38Max, opt => { opt.MapFrom(src => src._38 != null ? src._38.Max : -1); })
                .ForMember(dest => dest._42Min, opt => { opt.MapFrom(src => src._42 != null ? src._42.Min : -1); })
                .ForMember(dest => dest._42Max, opt => { opt.MapFrom(src => src._42 != null ? src._42.Max : -1); })
                .ForMember(dest => dest._46Min, opt => { opt.MapFrom(src => src._46 != null ? src._46.Min : -1); })
                .ForMember(dest => dest._46Max, opt => { opt.MapFrom(src => src._46 != null ? src._46.Max : -1); })
                .ForMember(dest => dest._50Min, opt => { opt.MapFrom(src => src._50 != null ? src._50.Min : -1); })
                .ForMember(dest => dest._50Max, opt => { opt.MapFrom(src => src._50 != null ? src._50.Max : -1); })
                .ForMember(dest => dest._54Min, opt => { opt.MapFrom(src => src._54 != null ? src._54.Min : -1); })
                .ForMember(dest => dest._54Max, opt => { opt.MapFrom(src => src._54 != null ? src._54.Max : -1); })
                .ForMember(dest => dest._58Min, opt => { opt.MapFrom(src => src._58 != null ? src._58.Min : -1); })
                .ForMember(dest => dest._58Max, opt => { opt.MapFrom(src => src._58 != null ? src._58.Max : -1); })
                .ForMember(dest => dest._63Min, opt => { opt.MapFrom(src => src._63 != null ? src._63.Min : -1); })
                .ForMember(dest => dest._63Max, opt => { opt.MapFrom(src => src._63 != null ? src._63.Max : -1); })
                .ForMember(dest => dest._68Min, opt => { opt.MapFrom(src => src._67 != null ? src._67.Min : -1); })
                .ForMember(dest => dest._68Max, opt => { opt.MapFrom(src => src._67 != null ? src._67.Max : -1); })
                .ForMember(dest => dest._71Min, opt => { opt.MapFrom(src => src._71 != null ? src._71.Min : -1); })
                .ForMember(dest => dest._71Max, opt => { opt.MapFrom(src => src._71 != null ? src._71.Max : -1); })
                .ForMember(dest => dest._75Min, opt => { opt.MapFrom(src => src._75 != null ? src._75.Min : -1); })
                .ForMember(dest => dest._75Max, opt => { opt.MapFrom(src => src._75 != null ? src._75.Max : -1); })
                .ForMember(dest => dest._79Min, opt => { opt.MapFrom(src => src._79 != null ? src._79.Min : -1); })
                .ForMember(dest => dest._79Max, opt => { opt.MapFrom(src => src._79 != null ? src._79.Max : -1); })
                .ForMember(dest => dest._83Min, opt => { opt.MapFrom(src => src._83 != null ? src._83.Min : -1); })
                .ForMember(dest => dest._83Max, opt => { opt.MapFrom(src => src._83 != null ? src._83.Max : -1); })
                .ForMember(dest => dest._88Min, opt => { opt.MapFrom(src => src._88 != null ? src._88.Min : -1); })
                .ForMember(dest => dest._88Max, opt => { opt.MapFrom(src => src._88 != null ? src._88.Max : -1); })
                .ForMember(dest => dest._92Min, opt => { opt.MapFrom(src => src._92 != null ? src._92.Min : -1); })
                .ForMember(dest => dest._92Max, opt => { opt.MapFrom(src => src._92 != null ? src._92.Max : -1); })
                .ForMember(dest => dest._96Min, opt => { opt.MapFrom(src => src._96 != null ? src._96.Min : -1); })
                .ForMember(dest => dest._96Max, opt => { opt.MapFrom(src => src._96 != null ? src._96.Max : -1); })
                .ForMember(dest => dest._100Min, opt => { opt.MapFrom(src => src._100 != null ? src._100.Min : -1); })
                .ForMember(dest => dest._100Max, opt => { opt.MapFrom(src => src._100 != null ? src._100.Max : -1); });
