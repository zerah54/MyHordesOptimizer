    ...
    public class MyHordesMappingProfiles : Profile
    {
        public MyHordesMappingProfiles()
        {
            ...
            CreateMap<EstimationsDto, TownEstimationModel>()
                ...
                .ForMember(dest => dest._68Min, opt => { opt.MapFrom(src => src._68.Min); opt.Condition(src => src._68 != null); })
                .ForMember(dest => dest._68Max, opt => { opt.MapFrom(src => src._68.Max); opt.Condition(src => src._68 != null); })
            ...
            CreateMap<TownEstimationModel, EstimationsDto>()
                ...
                .ForMember(dest => dest._68, opt => { opt.MapFrom(src => new EstimationValueDto() { Min = src._68Min.Value, Max = src._68Max.Value }); opt.PreCondition(src => src._68Min.HasValue && src._68Max.HasValue); })
