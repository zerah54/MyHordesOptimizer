...
{
    public class MyHordesCampingBonusModel
    {
        [JsonProperty("tomb")] 
        ...
        [JsonProperty("commonByAlreadyCamped")]
        public List<int> CommonByAlreadyCamped { get; set; }

        [JsonProperty("buriedBonus")] 
        public int BuriedBonus { get; set; }
