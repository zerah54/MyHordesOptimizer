...
ADD COLUMN hasRescue BIT NULL DEFAULT 1;

ALTER TABLE TownCitizen
ADD COLUMN APAGcharges INT NULL DEFAULT 3;

ALTER TABLE TownCitizen
ADD COLUMN hasUppercut BIT NULL DEFAULT 1;

ALTER TABLE TownCitizen
ADD COLUMN hasSecondWind BIT NULL DEFAULT 1;

ALTER TABLE TownCitizen
ADD COLUMN hasLuckyFind BIT NULL DEFAULT 1;

ALTER TABLE TownCitizen
ADD COLUMN hasCheatDeath BIT NULL DEFAULT 1;

ALTER TABLE TownCitizen
ADD COLUMN hasHeroicReturn BIT NULL DEFAULT 1;
...
-- Status
ALTER TABLE TownCitizen
ADD COLUMN isCleanBody BIT NULL DEFAULT 1;
