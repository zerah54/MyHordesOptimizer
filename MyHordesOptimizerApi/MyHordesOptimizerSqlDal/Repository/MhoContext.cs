    ...
    public partial class MhoContext : DbContext
    {
        ...
        public IQueryable<TownCitizen> GetTownCitizen(int townId)
        {
            return this.TownCitizens.Where(townCitizen => townCitizen.IdTown == townId)
                ...
                .Include(townCitizen => townCitizen.IdChestNavigation)
                    .ThenInclude(chest => chest.ChestItems)
                        .ThenInclude(chestItem => chestItem.IdItemNavigation)
                            .ThenInclude(item => item.PropertyNames)
                .Include(townCitizen => townCitizen.IdChestNavigation)
                    .ThenInclude(chest => chest.IdLastUpdateInfoNavigation)
                        .ThenInclude(lastUpdate => lastUpdate.IdUserNavigation)
