...
export class TutoScriptDisplayComponent {
    ...
    public readonly tuto_script_items: AccordionItem[] = [
        { title: $localize`Affichage des tooltips détaillés`, content: $localize`Modifie les tooltips natifs de l'application pour afficher en plus la liste des recettes dans lesquelles l'objet survolé apparait ainsi que quelques informations complémentaires (nombre de points d'action rendus par un aliment par exemple).` },
        {
        ...
        { title: $localize`Filtrer les chantiers`, content: $localize`En cochant cette option, un nouveau champ de filtre apparaitra dans la liste des chantiers.` },
