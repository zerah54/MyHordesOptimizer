...
export class DataImportComponent implements OnInit {
    ...
    protected readonly importActions: ImportAction[] = [
        ...
        { key: 'ruins', label: $localize`Bâtiments`, icon: 'domain', fn: () => this.adminService.importRuins() },
        { key: 'pictos', label: $localize`Pictos`, icon: 'emoji_events', fn: () => this.adminService.importPictos() },
        { key: 'buildings', label: $localize`Chantiers`, icon: 'apartment', fn: () => this.adminService.importBuildings() },
