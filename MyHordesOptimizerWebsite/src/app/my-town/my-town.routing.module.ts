...
import { CampingComponent } from '../tools/camping/camping.component';
...
let routes: Routes = [
    ...
    { path: 'my-town', redirectTo: 'my-town/citizens' },
    {
        path: 'my-town', children: [
            ...
            { path: 'buildings', component: BuildingsComponent, title: 'MyHordes Optimizer' + ' - ' + $localize`Ma ville` + ' - ' + $localize`Chantiers`, canActivate: [IsInTownGuard] },
            { path: 'campings', component: CampingComponent, title: 'MyHordes Optimizer' + ' - ' + $localize`Ma ville` + ' - ' + $localize`Campings`, canActivate: [IsInTownGuard] },
            ...
            { path: 'nightwatch', component: NightwatchComponent, title: 'MyHordes Optimizer' + ' - ' + $localize`Ma ville` + ' - ' + $localize`Veilles`, canActivate: [IsInTownGuard] },
